  ...
  <div class="p-2">
    ...
    <el-card shadow="never">
      <el-table v-loading="loading" :data="reportList">
        <el-table-column label="代理线" align="center" prop="proxyName" />
...
<script setup name="ProxyReport" lang="ts">
import { getProxyReport } from '@/api/report/index';
...
const getList = async () => {
  loading.value = true;
  const res = await getProxyReport(queryParams.value);
