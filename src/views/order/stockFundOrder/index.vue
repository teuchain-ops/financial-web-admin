<template>
  <div class="p-2">
    <transition :enter-active-class="proxy?.animate.searchAnimate.enter" :leave-active-class="proxy?.animate.searchAnimate.leave">
      <div class="search" v-show="showSearch">
        <el-form :model="queryParams" ref="queryFormRef" :inline="true" label-width="90px">
          ...
          <el-form-item label="基金ID" prop="name">
            <el-input v-model="queryParams.fundId" placeholder="基金ID" clearable style="width: 240px" @keyup.enter="handleQuery" />
          </el-form-item>
          ...
          <el-form-item label="流水号" prop="name">
            <el-input v-model="queryParams.orderNo" placeholder="流水号" clearable style="width: 240px" @keyup.enter="handleQuery" />
          </el-form-item>
          <el-form-item label="状态" prop="status">
            <el-input v-model="queryParams.status" placeholder="请输入状态：1(开启)、2(关闭)" clearable style="width: 240px"/>
          </el-form-item>
          <el-form-item>
    ...
    <el-card shadow="never">
      ...
      <el-table v-loading="loading" :data="stockFundList" @selection-change="handleSelectionChange" v-hasPermi="['order:stockFundOrder:list']">
        ...
        <el-table-column label="用户账号" align="center" prop="memberName" />
        <el-table-column label="状态" align="center" prop="status">
          <template #default="scope"> {{ scope.row.status === 1 ? "开启" : "禁用" }} </template>
        </el-table-column>
        <el-table-column label="手续费" align="center" prop="fee" />
        <el-table-column label="订单金额" align="center" prop="amount" />
        <el-table-column label="客户锁仓天数" align="center" prop="cycle" />
        <el-table-column label="锁仓天数" align="center" prop="lockCycle" />
        <el-table-column label="盈利" align="center" prop="profit" />
        <el-table-column label="盈利百分比" align="center" prop="profitPercent" />
        <el-table-column label="昨日盈利" align="center" prop="dayProfit" />
        <el-table-column label="昨日盈利百分比" align="center" prop="dayProfitPercent" />
...
import { listStockFundOrder } from '@/api/order/stockFundOrder';
import { StockFundOrderVO, StockFundOrderForm, StockFundOrderQuery } from '@/api/order/stockFundOrder/types';
...
const stockFundList = ref<StockFundOrderVO[]>([]);
...
const initFormData: StockFundOrderForm = {
  id: undefined,
  name: undefined,
  icon: undefined,
...
const data = reactive<PageData<StockFundOrderForm, StockFundOrderQuery>>({
  form: {...initFormData},
  queryParams: {
    pageNum: 1,
    pageSize: 10,
...
const getList = async () => {
  ...
  const res = await listStockFundOrder(queryParams.value);
